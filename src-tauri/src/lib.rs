...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::import_local_mcp_selection,
            commands::upsert_mcp_server,
            commands::set_mcp_secret,
            commands::delete_mcp_secret,
            commands::delete_mcp_server,
            commands::repair_local_mcp_server,
            ...
            commands::set_skill_collection,
            commands::set_skills_collection,
            commands::rename_collection,
            commands::clear_collection,
            commands::get_collection_parameters,
            commands::save_collection_parameter,
            commands::delete_collection_parameter,
            commands::apply_ai_skill_parameters,
