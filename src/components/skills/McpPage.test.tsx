  ...
  it('lands on source collections instead of raw MCP commands', () => {
    const markup = renderToStaticMarkup(
      <McpPage
        ...
        tools={[{ id: 'codex', label: 'Codex', avatar: null }, { id: 'claude_code', label: 'Claude Code', avatar: null }]}
        servers={[
    ...
    expect(markup).toContain('Skill Hub')
