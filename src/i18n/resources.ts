  ...
  en: {
    translation: {
      ...
      aiSettings: {
        ...
        testPassed: 'AI provider connection succeeded',
        saved: 'AI provider saved',
      },
      aiParse: {
        open: 'AI parse',
        title: 'AI parse source',
        sourceUrl: 'GitHub or website URL',
        provider: 'AI provider',
        parse: 'Parse with AI',
        confirm: 'Confirm configuration',
        cancel: 'Cancel',
        noProvider: 'Configure an enabled AI provider with an API key first.',
        unknown: 'Unknown source type',
        evidence: 'Source evidence',
        runtimeInstall: 'Runtime install',
        runtime: 'Runtime',
        autoFetch: 'auto-fetches dependencies at runtime',
        editPlan: 'Review and edit configuration plan',
        invalidPlan: 'Configuration plan must be valid JSON.',
        wrongKind: 'This source was classified for a different workflow.',
        skillReady: 'AI plan applied to the Skill form. Review and install when ready.',
      },
      ...
      mcp: {
        ...
        sourceSearch: 'Search MCP services…',
        sourceFilter: 'Source filter',
        allSources: 'All sources',
        sort: 'Sort MCP sources',
        sortUpdated: 'Recently updated',
        sortName: 'Name',
        batchSync: 'Sync all sources',
        scanLocal: 'Scan local MCP',
        localReviewTitle: 'Review local MCP services',
        localReviewSummary: 'Scanned {{hosts}} apps and found {{count}} services. Only selected services will be managed.',
        localCredentialMigration: 'Selected literal credentials will move to your OS credential store.',
        adoptSelected: 'Manage selected ({{count}})',
        viewMode: 'MCP view mode',
        gridView: 'Grid view',
        listView: 'List view',
        sourceCount: '{{count}} MCP services',
        manualSource: 'Skill Hub',
        edit: 'Edit',
        localSource: 'Local import · {{app}}',
        notSynced: 'Not synced yet',
        back: 'All sources',
        sourceSync: 'Sync this source',
        targetsTitle: 'Manage sync targets',
        targetsHelp: 'Choose the Apps that should receive this MCP service.',
        ...
        targetConflictTitle: 'Existing App configuration',
        targetConflictBody: '{{apps}} already has a standalone configuration for {{name}}. Replacing it creates an automatic backup and makes Skills Hub the manager for that App.',
        keepLocal: 'Keep local configuration',
        replaceAndManage: 'Replace and manage',
        name: 'Name',
        transport: 'Transport',
        command: 'Command',
        args: 'Arguments',
        ...
        url: 'Server URL',
        headerName: 'Credential header name',
        secrets: 'Credential names',
        secretPrompt: 'Enter a value for {{name}}. It will be saved only in your OS keychain.',
        secretValue: '{{name}} value',
        secretConfigured: 'Configured — enter a replacement to update',
        sync: 'Sync all apps',
        empty: 'No MCP servers configured yet.',
        noSecrets: 'No credentials required',
        secretStatus: '{{count}}/{{total}} credentials saved in your OS keychain',
        saved: 'MCP server saved.',
        runtimeInstalled: 'Runtime installed ({{tool}}: {{packages}}).',
        runtimeAutoFetch: 'Runtime {{runtime}} will auto-fetch dependencies on first launch.',
        runtimeFailed: 'Runtime install issue: {{detail}}',
        synced: 'MCP server synced to all supported apps.',
      },
      mcpImport: { title: 'Add MCP', help: 'Search GitHub for MCP servers, import a configuration, or configure one manually.', github: 'GitHub', manual: 'Manual configuration', url: 'Repository or config URL', scan: 'Scan configuration', searchTitle: 'Search by name', searchPlaceholder: 'e.g. tavily, playwright…', searchButton: 'Search', searchResults: 'GitHub repositories', searchHint: 'Click a repository to scan and install it into ~/.skill-hub.', scanRepo: 'Scan & install', emptyTitle: 'Discover MCP services from a source', empty: 'Search by name or paste a GitHub repository URL to discover MCP servers.', resultsTitle: 'Discovered configurations', resultsHint: 'Select the services to add to your workspace.', importSelected: 'Import selected servers' },
      disabled: 'Disabled',
      enableSkill: 'Enable',
      ...
      bulk: {
        ...
        clear: 'Clear',
        tags: 'Tags',
        assignCollection: 'Assign to series',
        sync: 'Tools',
        enable: 'Enable',
        disable: 'Disable',
        delete: 'Delete',
      ...
      // Collections (series)
      collectionsEmpty: 'No skill series yet. Install a set via a git repo, or organize existing skills manually.',
      collectionSkillCount: '{{count}} skills',
      uncategorizedCollection: 'Uncategorized',
      uncategorizedHint: 'Assign these to a series',
      backToCollections: 'Back to series',
      renameCollection: 'Rename series',
      renameCollectionPrompt: 'Rename series',
      clearCollection: 'Ungroup all',
      clearCollectionConfirm: 'Remove all skills from series "{{name}}"?\nSkills remain but return to Uncategorized.',
      assignCollection: 'Assign to series',
      assignCollectionCurrent: 'In series: {{name}}',
      assignCollectionTitle: 'Assign to series',
      assignCollectionSubtitle: '{{count}} skill(s) selected',
      assignCollectionExisting: 'Existing series',
      assignCollectionNew: 'Create new series',
      assignCollectionClear: 'Remove from series (Uncategorized)',
      assignCollectionNewPlaceholder: 'New series name',
      ...
      collectionParameters: {
        ...
        description: 'Values are written to this collection’s managed Skill .env files when saved.',
        add: 'Add parameter',
        ...
        leaveUnchanged: 'Leave blank to keep the current value',
      ...
      autoUpdateUnchangedShort: 'Unchanged',
      ...
      exploreInstallsSuffix: 'installs',
      exploreInstallCollection: 'Install collection',
      exploreInstallCollectionMissing: 'Install missing',
      exploreInstallCollectionHint:
        'Install every skill in this repository. You will be able to review the selection before it is applied.',
      ...
      tools: {
        ...
        kiro: 'Kiro',
        reasonix: 'Reasonix',
        custom_deepseek_harness: 'DeepSeek Harness',
        cursor: 'Cursor',
        amp: 'Amp',
  ...
  zh: {
    translation: {
      ...
      aiSettings: {
        ...
        clear: '清除密钥',
        test: '测试连接',
        testPassed: 'AI 提供商连接成功',
        saved: 'AI 提供商已保存',
      },
      aiParse: {
        open: 'AI 解析',
        title: 'AI 解析来源',
        sourceUrl: 'GitHub 或网站链接',
        provider: 'AI 提供商',
        parse: '使用 AI 解析',
        confirm: '确认配置',
        cancel: '取消',
        noProvider: '请先配置一个已启用且含 API Key 的 AI 提供商。',
        unknown: '未知来源类型',
        evidence: '来源依据',
        runtimeInstall: '运行环境安装',
        runtime: '运行环境',
        autoFetch: '运行时自动拉取依赖（无需预装）',
        editPlan: '审核并编辑配置计划',
        invalidPlan: '配置计划必须是有效 JSON。',
        wrongKind: '该来源被识别为另一种工作流。',
        skillReady: 'AI 计划已应用到 Skill 表单，请审核后安装。',
      },
      appVersion: '应用版本',
      projectLink: {
        title: '开源项目',
      ...
      mcp: {
        ...
        batchSync: '同步全部来源',
        scanLocal: '扫描本地 MCP',
        localReviewTitle: '审核本地 MCP 服务',
        localReviewSummary: '已扫描 {{hosts}} 个 App，发现 {{count}} 个服务；仅选中的服务会被纳入统一管理。',
        localCredentialMigration: '选中的本地明文凭据将迁入操作系统安全凭据库。',
        adoptSelected: '纳入统一管理（{{count}}）',
        viewMode: 'MCP 视图模式',
        gridView: '网格视图',
        listView: '列表视图',
        sourceCount: '{{count}} 个 MCP 服务',
        manualSource: 'Skill Hub',
        edit: '编辑',
        localSource: '本地导入 · {{app}}',
        notSynced: '尚未同步',
        back: '全部来源',
        sourceSync: '同步此来源',
        targetsTitle: '管理同步目标',
        targetsHelp: '选择需要接收此 MCP 服务的 App。',
        manageTargets: '管理目标',
        saveTargets: '保存目标',
        noTargets: '尚未选择 App',
        ...
        targetConflictTitle: 'App 已有本地配置',
        targetConflictBody: '{{apps}} 已有 {{name}} 的独立配置。替换前会自动备份，之后将由 Skills Hub 统一管理该 App 中的此服务。',
        keepLocal: '保留本地配置',
        replaceAndManage: '替换并纳入管理',
        name: '名称',
        transport: '传输方式',
        command: '命令',
        args: '参数',
        ...
        headerName: '凭据请求头名称',
        secrets: '凭据名称',
        secretPrompt: '输入 {{name}} 的值；它只会保存在操作系统安全凭据库中。',
        secretValue: '{{name}} 的值',
        secretConfigured: '已配置——输入新值即可更新',
        sync: '同步全部应用',
        empty: '尚未配置 MCP 服务。',
        noSecrets: '无需凭据',
        secretStatus: '已有 {{count}}/{{total}} 个凭据保存到系统钥匙串',
        saved: 'MCP 服务已保存。',
        runtimeInstalled: '运行环境已安装（{{tool}}：{{packages}}）。',
        runtimeAutoFetch: '运行环境 {{runtime}} 将在首次启动时自动拉取依赖。',
        runtimeFailed: '运行环境安装问题：{{detail}}',
        synced: 'MCP 服务已同步到全部受支持应用。',
      },
      mcpImport: { title: '添加 MCP', help: '从 GitHub 搜索 MCP 服务器、导入配置，或手动配置服务。', github: 'GitHub', manual: '手动配置', url: '仓库或配置链接', scan: '扫描配置', searchTitle: '按名称搜索', searchPlaceholder: '例如 tavily、playwright…', searchButton: '搜索', searchResults: 'GitHub 仓库', searchHint: '点击仓库即可扫描并安装到 ~/.skill-hub。', scanRepo: '扫描并安装', emptyTitle: '从来源发现 MCP 服务', empty: '按名称搜索或粘贴 GitHub 仓库链接以发现 MCP 服务。', resultsTitle: '已发现的配置', resultsHint: '选择要加入工作区的服务。', importSelected: '导入所选服务' },
      disabled: '已停用',
      enableSkill: '启用',
      disableSkill: '停用',
      ...
      tagRenamed: '标签已重命名。',
      // 系列（Collections）
      collectionsEmpty: '暂无 skill 系列。通过 git 仓库安装一组 skill，或对现有 skill 手动整理。',
      collectionSkillCount: '{{count}} 个 Skills',
      uncategorizedCollection: '未分组',
      uncategorizedHint: '手动整理到系列',
      backToCollections: '返回系列列表',
      renameCollection: '重命名系列',
      renameCollectionPrompt: '重命名系列',
      clearCollection: '解散系列',
      clearCollectionConfirm: '将系列「{{name}}」中的所有 Skills 移出？\nSkills 会保留，但归入未分组。',
      assignCollection: '分配到系列',
      assignCollectionCurrent: '当前系列：{{name}}',
      assignCollectionTitle: '分配到系列',
      assignCollectionSubtitle: '已选 {{count}} 个 Skill',
      assignCollectionExisting: '已有系列',
      assignCollectionNew: '新建系列',
      assignCollectionClear: '移出系列（归入未分组）',
      assignCollectionNewPlaceholder: '新系列名',
      ...
      collectionParameters: {
        configure: '配置参数',
        title: '参数：{{name}}',
        description: '保存后，参数会写入该系列受管 Skill 的 .env 文件。',
        add: '添加参数',
        name: '环境变量名称',
        descriptionLabel: '说明',
        noDescription: '暂无说明',
      ...
      exploreInstallsSuffix: '次安装',
      exploreInstallCollection: '安装合集',
      exploreInstallCollectionMissing: '补装缺失',
      exploreInstallCollectionHint: '安装该仓库中的全部 Skill；确认前会列出待安装项供你调整。',
