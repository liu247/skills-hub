export const resources = {
  ...
  zh: {
    translation: {
      ...
      mcpImport: { title: '添加 MCP', help: '从 GitHub 导入安全的 MCP 配置，或手动配置服务。', github: 'GitHub', manual: '手动配置', url: '仓库或配置链接', scan: '扫描配置', empty: '粘贴 GitHub 仓库或配置链接以发现 MCP 服务。', importSelected: '导入所选服务' },
      disabled: '已停用',
      enableSkill: '启用',
      disableSkill: '停用',
