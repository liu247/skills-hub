export const resources = {
  en: {
    translation: {
      ...
      mcp: {
        ...
        manualSource: 'Manual configuration',
      ...
      mcpImport: { title: 'Add MCP', help: 'Import a safe MCP configuration from GitHub, or configure one manually.', github: 'GitHub', manual: 'Manual configuration', url: 'Repository or config URL', scan: 'Scan configuration', emptyTitle: 'Discover MCP services from a source', empty: 'Paste a GitHub repository or configuration URL to discover MCP servers.', resultsTitle: 'Discovered configurations', resultsHint: 'Select the services to add to your workspace.', importSelected: 'Import selected servers' },
      disabled: 'Disabled',
      enableSkill: 'Enable',
  ...
  zh: {
    translation: {
      ...
      mcpImport: { title: '添加 MCP', help: '从 GitHub 导入安全的 MCP 配置，或手动配置服务。', github: 'GitHub', manual: '手动配置', url: '仓库或配置链接', scan: '扫描配置', emptyTitle: '从来源发现 MCP 服务', empty: '粘贴 GitHub 仓库或配置链接以发现 MCP 服务。', resultsTitle: '已发现的配置', resultsHint: '选择要加入工作区的服务。', importSelected: '导入所选服务' },
      disabled: '已停用',
      enableSkill: '启用',
      disableSkill: '停用',
